...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '小蛇', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '飞舞一条', // 作者简介
  ...
  MUSIC_PLAYER_ORDER: process.env.NEXT_PUBLIC_MUSIC_PLAYER_ORDER || 'ramdom', // 默认播放方式，顺序 list，随机 random
